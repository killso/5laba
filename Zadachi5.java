...
public class Zadachi5 {
    ...
    public static int[] encrypt(String str) {
        int[] shifr = new int [str.length()];
        shifr[0] = (int)str.charAt(0);
        for (int i = 1; i <str.length(); i++) {
            shifr[i] = (int)str.charAt(i) - (int)str.charAt(i - 1);
        }
        return shifr;
    }
   public static String decrypt(int[] mas) {
        ...
        for (int i = 1; i < mas.length; i++) {
            a +=mas[i];
            String sim = Character.toString((char) a);
            res +=sim;
        }
        return res;
    }
    ...
    public static boolean canMove(String figure, String position, String futurePosition) {
        ...
        switch (figure) {
            case "Ферзь":
                ...
                end= fLetter < 9 && fNumber < 9;
                return ((horizontal ^ vertical) || diagonal) &&end;
            case "Король":
            ...
            case "Пешка":
                ...
                return horizontal && vertical && end;
            case "Конь":
...
//4 задача
    ...
    //6 задача
    public static boolean validateCard(String line) {
